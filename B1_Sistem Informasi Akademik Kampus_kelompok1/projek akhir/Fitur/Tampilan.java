...
public class Tampilan {
    ...
    public static void tampilHeader(String nama, String role,
                                    String tahun, String semester_aktif) {
    ...
    public static void tampilMenuDosen() {
        String[] menu = {
            ...
            "[3] Kelas Saya",
            "[4] Kelola KRS Mahasiswa Bimbingan",
            "[5] Input Nilai",
            "[6] Input Presensi",
            "[7] Rekap Kehadiran Mahasiswa",
            "[8] Mahasiswa Bimbingan Saya",
            "[9] Logout",
            "[0] Keluar"
        };
    ...
    // ===================== MENU ADMIN =====================
    public static void tampilMenuAdmin() {
        String[] menu = {
            "[1] Data Master",
            "[2] Kelola Akun",
            "[3] Assign Dosen Pembimbing",
            "[4] Ganti Dosen Pembimbing",
            "[5] Lihat Semua Pembimbing",
            "[6] Logout",
            "[0] Keluar"
        };
        tampilMenu("MENU ADMIN", menu);
    }
    ...
    public static void peringatan(String pesan) { System.out.println("\n[!] " + pesan); }
